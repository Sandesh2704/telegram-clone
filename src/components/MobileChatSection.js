...
import { Box, TextField, IconButton, Paper, List, ListItem, Avatar, Typography } from '@mui/material';
...
const MoblieChatSection = () => {
  ...
  const { messages, fetchMessages, setSelectedChatId, mode } = useData();
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          <Box display="flex" alignItems='center'>
            ...
            <Typography sx={{ fontSize: '1rem', marginLeft: 2 }}>
              {messages[0]?.sender.name || 'Unknown'}
            </Typography>
          </Box>
        </Box>
        <Box>
